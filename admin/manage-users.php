...
<meta content="Andiswa King Mabuza" name="author" />
                                                        ...
                                                        <td><?php echo $row['email'];?></td>
                                                         <td><?php echo $row['mobile'];?></td>
                                                          ...
                                                          <form name="abc" action="" method="post">
                                                           ...
                                                           <form name="def" action="" method="post">
                                                               <a href="delete-user.php?id=<?php echo $row['id'];?>" type="submit" class="btn btn-danger btn-xs btn-mini" name="delete">Delete </a>
                                                           </form>
                                                          </td>
                                                    </tr>
                                                    <?php $cnt=$cnt+1; } ?>
